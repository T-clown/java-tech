...
public class ImageUtil {
    ...
    // 水印文字字体
    private static Font font = new Font("微软雅黑", Font.PLAIN, 30);
    // 水印文字颜色
    ...
    public static void createImage(String[] strList, int[] sizes, String basePath, String targetPath)
        ...
        // 读取原图片信息
        File srcImgFile = new File("/Users/ti93/tmp/picture.png");
        Image srcImg = ImageIO.read(srcImgFile);
        graphic.drawImage(srcImg, 0, 300,
            500, 500, null);
        //graphic.drawImage(srcImg, 0,0, null);
        // 6.返回图片
    ...
    private byte[] zoomImage(byte[] data, int width, int height) throws IOException {
        ...
        return tranferImageToBytes(result);
    }

    private byte[] tranferImageToBytes(BufferedImage image) throws IOException {
    ...
    public static void main(String[] args) {
        ...
        contents[3]
            = "个人经历：1995年9月进入XXX小学，2000年9月进入某中学，2003年顺利升入本市高中，2006年考入某一本大学成为一名大学生，2010年考入北京一所大学成为一名研究生，2013年顺利毕业进入职场。";
        ...
        try {
            createImage(contents, sizes,
                "/Users/ti93/tmp/createImage.jpg",
                "/Users/ti93/tmp/createImage.jpg");
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        //markImageByIcon("/Users/ti93/tmp/test.jpg",
        //    "/Users/ti93/tmp/createImage.jpg", "/Users/ti93/tmp/createImage.jpg", 0);
    }
